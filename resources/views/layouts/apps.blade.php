...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'LeoEnergy') }}</title>
        <!-- Scripts -->
        <script src="{{ asset('js/app.js') }}" defer></script>
        <script src="{{ asset('js/calculatorScript.js') }}" defer></script>
        <!-- Fonts -->
            ...
            <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        ...
                        <img src="{{asset('storage/logo.png')}}" width="120" height="80" alt="logo">
                    </a>
                        ...
                        <div>
                            <form action="/search" method="POST" role="search"class="form-inline my-2 my-lg-0">
                                {{ csrf_field() }}
                                    ...
                                    <input class="form-control mr-sm-2" type="search" placeholder="Search Users" name="q" aria-label="Search">
